	...
	<SCRIPT type="text/javascript">
		function viewReport(){
    	   ...
    	   if(document.all.qymc.value!=""){
    	   	queryStr = "entname:" + document.all.qymc.value;//企业名称
    	  }
    	  if( document.all.gxdw.value){
    	  	queryStr += " +superorgid:" + document.all.gxdw.value;//管辖单位
    	  }
        
        if(document.all.zch.value!=""){
        	queryStr += " +regno:" + document.all.zch.value;//注册号
        	}
        //
        if(document.all.fddbr.value!=""){
        	queryStr += " + lerep:" + document.all.fddbr.value;//法定代表人
        	}
       // 
       if(document.all.jydz.value!=""){
       	queryStr += " + oploc:" + document.all.jydz.value;//经营场所
        	}
       // 
       if(document.all.dah.value!=""){
        queryStr += " +archno:" + document.all.dah.value;//档案号
      	}
       if(document.all.jyfw.value!=""){
       	queryStr += " + opscope:" + document.all.jyfw.value;//经营范围
        	}
       // 
       if(document.all.hmt.value!=""){
       	queryStr += " + industryphy:" + document.all.hmt.value; //行业门类
        	}
       // 
       if(document.all.hmi.value!=""){
       	queryStr += " + industryphy:" + document.all.hmi.value; //行业大类
        	}
       // 
       if(document.all.xyjb.value!=""){
       	queryStr += " + credLevel:" + document.all.xyjb.value;//信用级别
        	}
       // 
       if( document.all.hmm.value!=""){
       	queryStr += " + industrycoxi:" + document.all.hmm.value;//行业细类 
        	}
       // 
       if(document.all.hyxxl.value!=""){
       	queryStr += " + industrycoxiao:" + document.all.hyxxl.value; //行业小类
        	}
       // 
       if( document.all.qylx_xl.value!=""){
       	queryStr += " + enttypeitem:" + document.all.qylx_xl.value; //企业类型-小类
        	}
       // 
       if(document.all.qylx_zl.value!=""){
       	queryStr += " + enttype:" + document.all.qylx_zl.value; //企业中类
        	}
       // 
      // if(document.all.zt.value!=""){
       ...
       if( document.all.fxhy.value!=""){
       	queryStr += " + venind:" + document.all.fxhy.value;//风险行业
        	}
        //
        if(document.all.jylb.value!=""){
        	queryStr += " + optype:" + document.all.jylb.value;//经营类别
        	}
       // 
